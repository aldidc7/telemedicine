          ...
          <div class="relative z-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              <button
                ...
                class="bg-white text-indigo-600 px-6 py-3 md:px-8 md:py-4 rounded-2xl font-bold hover:shadow-2xl active:scale-95 transition flex items-center justify-center gap-3 shadow-lg text-sm md:text-base"
              >
                <svg class="w-5 h-5 md:w-6 md:h-6 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                Buat Konsultasi
              </button>
              <router-link
                to="/cari-dokter"
                class="bg-indigo-500 hover:bg-indigo-600 text-white px-6 py-3 md:px-8 md:py-4 rounded-2xl font-bold active:scale-95 transition flex items-center justify-center gap-3 text-sm md:text-base shadow-lg hover:shadow-2xl"
              >
                <svg class="w-5 h-5 md:w-6 md:h-6 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                Cari Dokter
              </router-link>
              <router-link
              ...
              <router-link
                ...
                class="bg-indigo-500 hover:bg-indigo-600 text-white px-6 py-3 md:px-8 md:py-4 rounded-2xl font-bold active:scale-95 transition flex items-center justify-center gap-3 text-sm md:text-base shadow-lg hover:shadow-2xl"
              >
                <svg class="w-5 h-5 md:w-6 md:h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                Rating
              </router-link>
            </div>
          </div>
